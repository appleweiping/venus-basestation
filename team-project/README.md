...
## Extra: Syncing the PYNQ's main branch (NOT NEEDED)
The following should be avoided, unless we're done testing everything and want to check the final implementaion!!
1. Add the remote to your git repo `git remote add pynq-main student@10.43.0.1:/home/student/main`
2. Verify it's there `git remote -v`
3. Push to the pynq's main repo `git push pynq-main main`
